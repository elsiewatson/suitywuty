...
export class ModernsheathdressesComponent {
  product = ProductData;
  constructor(private titleService: Title, private metaService: Meta) {}

  ngOnInit(): void {
    // Set the meta title
    this.titleService.setTitle('Elegant modern sheath dress | Suitywuty');

    // Set the meta description
    this.metaService.updateTag({
      name: 'description',
      content:
        'Find the perfect fit with our sheath dress. Rent this figure-flattering design to attend your upcoming special occasion.',
    });
  }
}
